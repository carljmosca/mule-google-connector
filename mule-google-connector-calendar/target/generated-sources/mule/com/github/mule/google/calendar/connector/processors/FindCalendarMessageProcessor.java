...
/**
 * FindCalendarMessageProcessor invokes the {@link com.github.mule.google.calendar.connector.CalendarConnector#findCalendar(java.lang.String)} method in {@link CalendarConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@Generated(value = "Mule DevKit Version 3.4.0", date = "2013-09-10T03:24:40-04:00", comments = "Build 3.4.0.1555.8df15c1")
public class FindCalendarMessageProcessor
    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            ...
            final String _transformedSummary = ((String) evaluateAndTransform(getMuleContext(), event, FindCalendarMessageProcessor.class.getDeclaredField("_summaryType").getGenericType(), null, summary));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((CalendarConnector) object).findCalendar(_transformedSummary);
                }
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("findCalendar"), event, e);
        }
    }
